...
def parse_arguments():
    ...
    parser.add_argument("--tfad_dir", type=PosixPath, default='.')
    parser.add_argument("--data_dir", type=PosixPath, default='./data')
    parser.add_argument("--hparams_dir", type=PosixPath,
                        default='./article/hparams')
    parser.add_argument("--out_dir", type=PosixPath, default='./outputs')
    ...
    parser.add_argument("--run_swat", type=str_to_bool, default=False)
    parser.add_argument("--run_yahoo", type=str_to_bool, default=False)
